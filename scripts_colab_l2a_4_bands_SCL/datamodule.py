...
class CoreDataModule(pl.LightningDataModule):
    def __init__(self, dataframe: pd.DataFrame, dataframe_extra, batch_size: int = 4):
        super().__init__()
        ...
        self.dataset_extra = dataframe_extra
    ...
    def test_dataloader(self):
        return torch.utils.data.DataLoader(
            dataset=CoreDataset(self.test_dataset, self.dataset_extra),
            batch_size=self.batch_size,
            num_workers=11,
        )
